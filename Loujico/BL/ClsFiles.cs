...
namespace Loujico.BL
{
    public interface IFiles
    {
        ...
        public  Task<bool> Add(FileModel file, string folderPath, int? Id, string EntityType, string userName);
    ...
    public class ClsFiles : IFiles
    {
        ...
        public async Task<bool> Add(FileModel file, string folderPath, int? Id , string EntityType,string userName)
        {
            try
            {
