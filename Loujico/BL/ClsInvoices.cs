...
//        public ClsInvoices(CompanySystemContext companySystemContext,IHistory history,Ilog ilog)
//        {
...
//            try
//            {
//                var LstInvoice = await ClsHistory.GetAllHistory(Pageid, id, tableName.invoice, count);
//                if (LstInvoice == null)
//                {
//                    return null;
//                }
...
//                            a.ProjectId.ToString().Contains(name) ||
